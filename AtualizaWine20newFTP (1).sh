...
sudo apt-get update;
cd /home/$USER/bin;
wget -m  -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/manualLinux/nbs;
chmod ugo+x /home/$USER/bin/nbs;
cd /home/$USER/Área\ de\ Trabalho;
wget -m  -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/manualLinux/NBS.desktop;
cd /home/$USER/nbs/;
sudo chmod 777 *;
rm *.reg;
sudo wget -m  -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/manualLinux/*.reg;
sudo chmod 777 *;
...
sudo wget -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/BDE/BDE.tar;
sudo tar -xvf BDE.tar;
sudo mkdir /home/$USER/nbs/drive_c/oracle;
cd /home/$USER/nbs/drive_c/oracle/;
sudo wget -m  -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/BDE/instantclient_10_2.tar;
...
sudo wget -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/manualLinux/bdeconfiguracao.CFG;
...
mkdir NBS
cd NBS
sudo wget -r  -nd ftp://portalgeracao:GeracaoFTP.1212@187.45.240.15/public_html/NBS/nbs.zip;
unzip nbs.zip;
cd /home/$USER/Downloads/;
sudo rm -r Wine;
sudo rm *.deb;
